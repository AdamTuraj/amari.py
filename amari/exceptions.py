...
__all__ = ("AmariException", "HTTPException", "NotFound", "InvalidToken", "RatelimitException", "AmariServerError")
...
class NotFound(HTTPException):
    ...
    def __init__(self, response: aiohttp.ClientResponse, message: Optional[str] = "Guild or user was not found."):
...
class RatelimitException(HTTPException):
    ...
    def __init__(self, response: aiohttp.ClientResponse, message: Optional[str] = "Slow down! You are being ratelimited!"):
        super().__init__(response, message)
...
class AmariServerError(HTTPException):
    ...
    def __init__(self, response: aiohttp.ClientResponse, message: Optional[str] = "There was an internal error in the Amari servers."):
        super().__init__(response, message)
